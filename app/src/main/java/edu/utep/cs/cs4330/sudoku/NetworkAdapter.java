...
public class NetworkAdapter{
    ...
    /** Associated TCP/IP socket to communicate with the peer. */
    private Socket socket;

    /** Associated bluetooth socket to communicate with the peer. */
    ...
    /** Is TCP/IP socket communication? */
    public boolean isSocket() {
        return socket != null;
    }

    /** Is bluetooth communication? */
    public boolean isBluetooth() {
        return bluetoothSocket != null;
    }

    /** Return the associated TCP/IP socket or null. */
    public Socket socket() {
        return socket;
    }

    /** Return the associated bluetooth socket or null. */
